...
const bannerComeçarOuPausar = document.querySelector('.app__card-primary-butto-icon')
...
function iniciarouPausar(){
    ...
    bannerComeçarOuPausar.setAttribute('src', '/imagens/pause.png')
}

function zerar (){
    clearInterval(intervaloId)
    iniciarOuPausarBt.textContent = 'Começar'
    bannerComeçarOuPausar.setAttribute('src', '/imagens/play_arrow.png')
    intervaloId = null
}
